...
public class TokFm {
    ...
    private void download(boolean skipOption) throws IOException, NoSuchAlgorithmException {
        ...
        for (int offset = 0; offset < 100000; offset++) {
            ...
            for (Podcast podcast : podcasts.getPodcasts()) {
                ...
                HttpPost request = prepareRequesst(podcast);
                HttpEntity entity = sendRequest(request);
                downloadTargetFile(toStream(entity), toStream(targetPath));
            }
        }
    }
    ...
    private void downloadTargetFile(InputStream inputStream, OutputStream outputStream) throws IOException {
    ...
    private HttpPost prepareRequesst(Podcast podcast) throws NoSuchAlgorithmException, UnsupportedEncodingException {
